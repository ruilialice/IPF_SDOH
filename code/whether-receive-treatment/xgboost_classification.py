...
file_name = '../data/data_treatment/new_output.csv'
...
# XGBoost classifier
xgb_model = XGBClassifier(use_label_encoder=False, n_estimators=1000, scale_pos_weight=pos_weight, eval_metric='logloss')
